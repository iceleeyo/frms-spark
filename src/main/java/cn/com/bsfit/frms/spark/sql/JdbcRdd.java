...
public class JdbcRdd {
	...
	private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(JdbcRdd.class);
	...
	public static void main(String[] args) {
		...
		JdbcRDD<Object[]> jdbcRDD = new JdbcRDD<>(sc.sc(), dbConnection,
				"select * from employees where emp_no >= ? and emp_no <= ?", 10001, 499999, 10, new MapResult(), null);
