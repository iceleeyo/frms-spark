 ...
 *
 * Usage: JavaFlumeEventCount <host> <port> <host> is the host the Flume
 * receiver will be started on - a receiver creates a server and listens for
 * flume events. <port> is the port the Flume receiver will listen on.
 *
